 ...
 */
    ...
    public int solution(int bridge_length, int weight, int[] truck_weights) {
        ...
        Queue<Truck2> outside = new LinkedList<>();
        List<Truck2> inside = new ArrayList<>();

        for (int t : truck_weights) {
            outside.add(new Truck2(t, bridge_length));
        }
    ...
    // !! 틀린 것은 아닌데 문제 이해를 잘 못 했음
    // 정렬 하는게 아니라 순서대로 가야 함
